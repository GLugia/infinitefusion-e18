...
class PokemonDataBox < SpriteWrapper
  ...
  def refresh
    ...
    if @battler.shiny?
      ...
      addShinyStarsToGraphicsArray(imagePos,@spriteBaseX+shinyX,39, @battler.pokemon.bodyShiny?,@battler.pokemon.headShiny?,@battler.pokemon.debugShiny?)
    end
    ...
    if @battler.status != :NONE
      ...
      if s == :POISON && @battler.status_count > 0   # Badly poisoned
